    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu notifications">
                <div class="topnav-dropdown-header">
                    <span class="notification-title">Thông báo<ol></ol></span>
                    <a href="{{route('clear-all')}}" class="clear-noti"> Xóa tất cả thông báo </a>
                </div>
                ...
                <div class="topnav-dropdown-footer">
                    <a href="{{route('activity')}}">Xem tất cả hoạt động</a>
                </div>
            </div>
        </li>
        <!-- /Notifications -->
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{route('Xemthongtincanhan')}}">Thông tin cá nhân</a>
