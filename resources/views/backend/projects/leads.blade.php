...
<div class="row align-items-center">
	<div class="col">
		<h3 class="page-title">Dự án khách hàng tiềm năng</h3>
		<ul class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
			<li class="breadcrumb-item active">Khách hàng tiềm năng</li>
		</ul>
	</div>
	<div class="col-auto float-right ml-auto">
		<a href="#" class="btn add-btn" data-toggle="modal" data-target="#create_project"><i class="fa fa-plus"></i> Thêm khách hàng tiền năng</a>
        ...
        <div class="table-responsive">
            <table class="table table-striped custom-table datatable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Tên khách hàng tiềm năng</th>
                        <th>Email</th>
                        <th>Dự án</th>
