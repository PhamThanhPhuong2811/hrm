...
<div class="row align-items-center">
	<div class="col">
		<h3 class="page-title">Loại nghỉ phép</h3>
		<ul class="breadcrumb">
	...
	<div class="col-auto float-right ml-auto">
		<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_leavetype"><i class="fa fa-plus"></i> Thêm loại nghỉ phép</a>
	</div>
</div>
@endsection
							...
							<td class="text-right">
								<div class="dropdown dropdown-action">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a data-id="{{$leave_type->id}}" data-type="{{$leave_type->type}}" data-days="{{$leave_type->days}}" class="dropdown-item editbtn" href="#" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Chỉnh sửa</a>
										<a data-id="{{$leave_type->id}}" class="dropdown-item deletebtn" href="#" data-toggle="modal" ><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
									</div>
								</div>
							</td>
						</tr>
						@endforeach
						<x-modals.delete :route="'leave-type.destroy'" :title="'Loại nghỉ phép'" />
					@endif										
				</tbody>
			</table>
		</div>
