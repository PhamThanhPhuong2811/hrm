			...
			<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
				<div class="profile-widget">
					<div class="profile-img">
						<a href="javascript:void(0)" class="avatar"><img height="80px" width="80px" alt="" src="@if(!empty($client->avatar)) {{asset('storage/clients/'.$client->avatar)}} @else assets/img/profiles/default.jpg @endif"></a>
					</div>
					...
					<h4 class="user-name m-t-10 mb-0 text-ellipsis">Họ và tên: <a href="javascript:void(0)">{{$client->firstname}} {{$client->lastname}}</a></h4>
					<h5 class="user-name m-t-10 mb-0 text-ellipsis">SĐT: <a href="javascript:void(0)">{{$client->phone}}</a></h5>
					<h5 class="user-name m-t-10 mb-0 text-ellipsis">Email: <a href="javascript:void(0)">{{$client->email}}</a></h5>
				</div>
			</div>
		@endforeach
		<x-modals.delete :route="'client.destroy'" :title="'Khách hàng'" />
					...
					<div class="modal-body">
						<form method="POST" enctype="multipart/form-data" action="{{route('client.update')}}">
							...
							<div class="row">
								...
								<div class="col-md-6">  
									<div class="form-group">
										<label class="col-form-label">Ảnh đại diện<span class="text-danger">*</span></label>
