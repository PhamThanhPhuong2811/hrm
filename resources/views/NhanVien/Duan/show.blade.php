                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <div class="project-title">
                            ...
                            <small class="block text-ellipsis m-b-15"><span class="text-xs">2</span> <span class="text-muted">Nhiệm vụ mở, </span><span class="text-xs">5</span> <span class="text-muted">Nhiệm vụ hoàn thành</span></small>
                        </div> --}}
                        <p>
